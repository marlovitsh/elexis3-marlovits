 ...
 * </p>
 */
public abstract class AbstractTableEditor extends FieldEditor {
     ...
     */
    protected AbstractTableEditor(String name, String labelText, Composite parent) {
        init(name, labelText);
