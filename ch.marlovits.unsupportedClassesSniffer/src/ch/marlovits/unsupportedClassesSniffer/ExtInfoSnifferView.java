...
public class ExtInfoSnifferView extends ViewPart {
	public static final String ID = "ch.marlovits.unsupportedClassesSniffer.ExtInfoSnifferView";

	public static Text snifferList;
	public static Text unresolvedClasses;
	public static Text snifferErrorsList;

	public ExtInfoSnifferView() {
	}
	...
	public void createPartControl(Composite parent) {
		...
		for (String sniffy : ExtInfoSniffer.snifferList)
