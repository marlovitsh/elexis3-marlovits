...
public class KrankenkassenTarifSH extends VerrechenbarAdapter {
	public static final String CODESYSTEM_CODE_KKTARIFSH = "2"; //$NON-NLS-1$
	public static final String MULTIPLICATOR_NAME = "KKTARIFSH"; //$NON-NLS-1$
	public static final String CODESYSTEM_NAME = "KK Tarif SH (Ae)"; //$NON-NLS-1$
	public static final String XIDDOMAIN = "marlovits.ch/aeskulap/krankenkassentarifSH/"; //$NON-NLS-1$
	...
	private final static String TABLENAME = "CH_MARLOVITS_AESKULAP_KRANKENKASSENTARIF_SH"; //$NON-NLS-1$
	...
	private static final IOptifier kktshoptifier = new KrankenkassenTarifSHOptifier();
	...
	static {
		...
		KrankenkassenTarifSH version = load("1"); //$NON-NLS-1$
		if (!version.exists()) {
			createOrModifyTable(createTable);
		}
		Xid.localRegisterXIDDomainIfNotExists(XIDDOMAIN,
				"Krankenkassentarif SH", Xid.ASSIGNMENT_REGIONAL); //$NON-NLS-1$
	}
	...
	public static KrankenkassenTarifSH load(final String id) {
		return new KrankenkassenTarifSH(id);
	}

	protected KrankenkassenTarifSH(final String id) {
		super(id);
	}

	public KrankenkassenTarifSH() {
	}
	...
	public String getCodeSystemCode() {
		return CODESYSTEM_CODE_KKTARIFSH;
	}

	@Override
	public IOptifier getOptifier() {
		return kktshoptifier;
	}
