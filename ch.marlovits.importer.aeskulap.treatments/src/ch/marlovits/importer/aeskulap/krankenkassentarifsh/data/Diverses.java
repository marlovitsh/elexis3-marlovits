...
//ch.marlovits.importer.aeskulap.krankenkassentarifsh.data.Diverse
...
public class Diverses extends VerrechenbarAdapter {
	public static final String CODESYSTEM_CODE_DIVERSES = "110"; //$NON-NLS-1$
	public static final String MULTIPLICATOR_NAME = "DIVERSE"; //$NON-NLS-1$
	public static final String CODESYSTEM_NAME = "Diverses (Ae)"; //$NON-NLS-1$
	public static final String XIDDOMAIN = "marlovits.ch/aeskulap/diverses/"; //$NON-NLS-1$
	...
	private final static String TABLENAME = "CH_MARLOVITS_AESKULAP_DIVERSES"; //$NON-NLS-1$
	...
	static {
		...
		Diverses version = load("1"); //$NON-NLS-1$
		if (!version.exists()) {
	...
	public static Diverses load(final String id) {
		return new Diverses(id);
	}

	protected Diverses(final String id) {
		super(id);
	}
	...
	public String getCodeSystemCode() {
		return CODESYSTEM_CODE_DIVERSES;
	}
